    ...
    <div id="map-container">
        ...
        <div id="panel">
            ...
            <div id="search-options">
                <!-- 검색 옵션 추가 -->
                <input type="text" class="form-control" id="keyword" placeholder="검색하기" value="현대"><hr> 
                <select class="form-select mt-2" id="charging-station-category"><hr>
                    <option value="">충전소 분류</option>
                    <option value="public">공공 충전소</option>
                    <option value="private">사설 충전소</option>
                </select> 
                <select class="form-select mt-2" id="charging-type"><hr>
              	...
              	<br>
                <!-- 검색, 초기화 버튼 -->
                <button id="search-btn" class="btn btn-outline-dark">검색하기</button>
                <button id="reset-btn" class="btn btn-outline-primary">초기화하기</button><hr>
        ...
        $(document).ready(function () {
         ...
         // 데이터 불러오기 및 표시 // 마커찍기
            ...
            function apiDetailRequest(es_statId) {
            	...
            	// modalTitle & modalBody 해당 요소를 할당
        		...
        		$.ajax({
        			...
        			success: function(json) {
        	            ...
        	            modalTitle.append('<h4>' + chargeAvg + '</h4>');
        	            modalTitle.append('<h4><a href="${pageContext.request.contextPath}/chargers/details?es_statId=' + es_statId + '"><button>상세정보</button></a></h4>');
