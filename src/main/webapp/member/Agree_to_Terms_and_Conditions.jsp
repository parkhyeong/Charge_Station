...
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 전기차 타요타요 및 전기차 타요타요 관련 제반 서비스를 의미합니다.
...
이용자는 회원가입을 하지 않아도 정보 검색, 공지, 게시글 보기 등 대부분의 전기차 타요타요 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 지도, 커뮤니티, 카드결제 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 전기차 타요타요는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.
...
제 1 조 (목적)
이 약관은 전기차 타요타요 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
2.위치정보를 활용한 검색결과 제공 서비스: 정보 검색을 요청하거나 개인위치정보주체 또는 이동성 있는 기기의 위치정보를 제공 시 본 위치정보를 이용한 검색결과 및 주변결과(주변업체, 교통수단 등)를 제시합니다.
3.위치정보를 활용한 전기차 충전소 찾기 및 충전: 현재 위치를 활용하여 전기차 충전소 찾거나 추천하여 줍니다.
