...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="/tayotayo/mainpage/MainPage.jsp">전기차 타요타요</a>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown"><a
                        ...
                        <ul class="dropdown-menu dropdown-menu-end"
                            ...
                            <li><a class="dropdown-item"
                                href="/tayotayo/mycard/pointPage.jsp">내 포인트</a></li>
                    ...
                    function getUsePointCardInformation(selectedCardNum) {
                        $.ajax({
                            ...
                            success: function (cardInfoList) {
                                console.log("포인트카드 정보:", cardInfoList);

                                var tableBody = $(
                                    "#cardInfoTableBody");
                                var currentPointElement = $(
                                    "#currentPoint");

                                tableBody.empty();

                                if (cardInfoList.length > 0) {
                                    // Assuming the first item in the list represents the current point
                                    var currentPoint = cardInfoList[0].card_point;
                                    currentPointElement.text(currentPoint);
                                    ...
                                    $
                                        .each(
                                            ...
                                            function (
                                                index, cardInfo) {
                                            	 var formattedChargeDay = cardInfo.point_day ? 
                                            			 cardInfo.point_day : getCurrentDate();
