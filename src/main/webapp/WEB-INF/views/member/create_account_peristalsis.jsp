...
<body>
	...
	<div id="wrapper">
		...
		<section>
			...
			<form action="create_account_insert" method="post"
				accept-charset="utf-8" onsubmit="return doAction()">
				<!-- ID -->
				<div>
					<h3 class="join_title">
					...
					<span class="box int_id"> <input type="text" id="id"
						class="int" maxlength="20" name="member_id" required> <span
						class="step_url">@tayotayo.com</span>
				...
				<div>
					...
					<span class="box int_pass"> <input type="password"
						id="pswd1" class="int" maxlength="20" name="pw" required>
						<span id="alertTxt">사용불가</span> <img
						src="${pageContext.request.contextPath}/resources/img/m_icon_pass.png"
				...
				<div>
					...
					<span class="box int_pass_check"> <input type="password"
						id="pswd2" class="int" maxlength="20" required> <img
						src="${pageContext.request.contextPath}/resources/img/m_icon_check_disable.png"
				...
				<div>
					...
					<span class="box int_name"> <input type="text" id="nickname"
						class="int" maxlength="20" name="nickname" required>
					</span> <span class="error_next_box"></span>
				</div>
				...
				<div>
					<h3 class="join_title">
						<label for="phoneNo">휴대전화</label><span> ( - 제외)</span>
					</h3>
				...
				<input type="hidden" name=id value="${social.id}"> <input
					type="hidden" name=type value="${social.type}">
	...
	<script>
		...
		function doAction() {
			...
			if (idok == 1 && passok == 1 && cpassok == 1 && nameok == 1
					&& nicknameok == 1 && telok == 1 && emailok == 1) {
				return true;
			} else {
				alert('다시 확인해주세요')
				return false;
