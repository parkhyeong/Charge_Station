...
<body>
        ...
        <div id="wrapper">
            ...
            <!-- section -->
            <section>
				<form action="create_account_insert" method="post" accept-charset="utf-8" onsubmit="return doAction()">
                <!-- ID -->
                <div>
                    <h3 class="join_title">
                ...
                <div>
                    ...
                    <span class="box int_email">
                        <input type="email" id="email" class="int" maxlength="100" placeholder="필수입력" name="email" required>
                    </span>
