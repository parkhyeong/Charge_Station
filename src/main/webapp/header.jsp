...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container">
			<a class="navbar-brand" href="/tayotayo/mainpage/MainPage.jsp">전기차
				타요타요</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="/tayotayo/mainpage/MainPage.jsp">Home</a></li>
					...
					<li class="nav-item"><a class="nav-link" href="chargers/select_all_p">충전소목록</a></li>
					...
					<li class="nav-item"><a class="nav-link"
						href="/tayotayo/member/login.jsp">로그인</a></li>
					<li class="nav-item"><a class="nav-link"
						href="/tayotayo/member/create_account.jsp">회원가입</a></li>
