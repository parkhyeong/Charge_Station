...
public class JoinVO {
	private String es_statId;
	private String stat;
	private String es_gungoo;
	private String es_addr;
	private String es_statNm;
	private String es_faciL;
	private String es_faciS;
	private String es_dvcL;
	private String es_dvcS;
	private String es_bnm;
	private String es_busiNm;
	private String es_output;
	private String es_chgerType;
	private String es_limit;
	private double es_lat;
	private double es_lon;
	...
	public String toString() {
		return "JoinVO [es_statId=" + es_statId + ", stat=" + stat + ", es_gungoo=" + es_gungoo + ", es_addr=" + es_addr
